...
# 👨🏾‍🦰 Gavin Humphrey - Python & Django Software Developer Portfolio

Welcome to the repository for my professional portfolio.

This project showcases my expertise in Python, Django, REST APIs, and full-stack development, including my work on highly available IT training platforms and specialized data services.

## 🔗 Quick Links

| Destination | Link |
| :--- | :--- |
| **🚀 Live Portfolio** | [**View My Live Portfolio Site**](https://[YOUR-GITHUB-USERNAME].github.io/[YOUR-REPO-NAME]/) |
...
_This repository is primarily for showcasing the source code and development history. For the best viewing experience, please use the **Live Portfolio Link** above._
